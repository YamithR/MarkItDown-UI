...
const I18N = {
  en: {
    ...
    aboutTitle: 'About',
    aboutDev: 'Developer',
    aboutRole: 'Ingeniero Mecatrónico',
    ...
    logClear: 'Clear',
    logConverting: 'Converting: {name}',
    logDone: 'Done: {name}',
    logFailed: 'Failed: {name} {err}',
    batchStart: 'Batch started: {total} file(s)',
    httpHint: '',
  },
  es: {
    ...
    aboutDev: 'Desarrollador',
    aboutRole: 'Ingeniero Mecatrónico',
    aboutRepo: 'Repositorio de GitHub',
    close: 'Cerrar',
    themeLabel: 'Cambiar modo oscuro',
    log: 'Registro',
    logTitle: 'Registro del proceso',
    logClear: 'Limpiar',
    logConverting: 'Convirtiendo: {name}',
    logDone: 'Listo: {name}',
    logFailed: 'Falló: {name} {err}',
    batchStart: 'Lote iniciado: {total} archivo(s)',
    httpHint: '',
  },
};
